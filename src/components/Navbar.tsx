...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black">
      <div className="mx-auto max-w-6xl flex items-center justify-between px-4 py-4">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <Link target="_blank" href="https://github.com/Expacio" className="hover:opacity-60 transition">
            GitHub
          </Link>
        </div>
        <button
